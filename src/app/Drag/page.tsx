...
import DraggableMultipleColumns from '@/components/Drag/DraggableComponents';
...
`;
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold mb-4">Draggable Item</h1>
